...
j=2;
for i=1:24
    [x,msg,it]= mRC2(@(x) ((1)+(((x(1,1)+x(2,1)+1)^2)*((19)+(-14*x(1,1))+(3*x(1,1)*x(1,1))+(-14*x(2,1))+(6*x(1,1)*x(2,1))+(3*x(2,1)*x(2,1)))))*((30)+((((2*x(1,1))+(-3*x(2,1)))^2)*((18)+(-32*x(1,1))+(12*x(1,1)*x(1,1))+(48*x(2,1))+(-36*x(1,1)*x(2,1))+(27*x(2,1)*x(2,1))))),x0,i);
    XY(j,:)=x;
    j=j+1;
end
